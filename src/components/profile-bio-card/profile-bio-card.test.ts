...
describe("ProfileBioCard Component", () => {
  ...
  it("should display the profile picture with correct attributes", () => {
    const img = element.shadowRoot?.querySelector(".profile-picture") as HTMLImageElement;
    expect(img).to.exist;
  ...
  it("should allow themePhoto property to be overridden", async () => {
    ...
    const img = customElement.shadowRoot?.querySelector(".profile-picture") as HTMLImageElement;
