...
import { AppSettings, ColorScheme, ColorSchemeContrast, ColorSchemeContrastIcons, colorSchemeSettingsToMaterialSchemeName, FabPosition, FabPositionIcons, FabPositions, fabPositionToUi, FabSettings, FabStyles, fabStyleToUi, SETTINGS_KEY_COLOR_SCHEME_CONTRAST, SETTINGS_KEYS_COLOR_SCHEME_NAMES } from "@/types/settings";
...
export type SettingsDialogEvents = "fab.settings.position.change" | "fab.connect.position.change";
...
export class SettingsDialog extends LitElement {
  ...
  static override styles = [
    ...
    css`
      ...
      dark-mode-toggle.dark {
        --dark-mode-toggle-dark-icon: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="%23FFB4AB"><path d="M481.15-140Q339-140 240.08-238.92 141.16-337.85 141.16-480q0-118.38 73.26-210.46 73.27-92.08 195.19-118.69 12.62-3.16 22.23.61 9.62 3.77 15.62 11.23 6 7.47 7.08 18.12 1.07 10.65-5 21.27-12.39 22.54-18.39 46.83t-6 51.09q0 98.33 68.84 167.17Q562.82-424 661.15-424q29.47 0 56.31-7.46 26.85-7.46 47-17.31 9.85-4.3 19.23-3.04 9.39 1.27 16.02 6.27 7.37 5 10.94 13.66 3.58 8.65.81 20.34-21.31 118-114.81 194.77Q603.15-140 481.15-140Zm0-60q88 0 158-48.5t102-126.5q-20 5-40 8t-40 3q-123 0-209.5-86.5T365.15-660q0-20 3-40t8-40q-78 32-126.5 102t-48.5 158q0 116 82 198t198 82Zm-10-270Z"/></svg>');
        --dark-mode-toggle-light-icon: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="%23FFB4AB"><path d="M352.54-352.54Q300-405.08 300-480q0-74.92 52.54-127.46Q405.08-660 480-660q74.92 0 127.46 52.54Q660-554.92 660-480q0 74.92-52.54 127.46Q554.92-300 480-300q-74.92 0-127.46-52.54ZM72.69-457.31q-9.66 0-16.18-6.56Q50-470.44 50-480.18q0-9.74 6.51-16.13 6.52-6.38 16.18-6.38h104.62q9.66 0 16.18 6.56 6.51 6.57 6.51 16.31 0 9.74-6.51 16.13-6.52 6.38-16.18 6.38H72.69Zm710 0q-9.66 0-16.18-6.56-6.51-6.57-6.51-16.31 0-9.74 6.51-16.13 6.52-6.38 16.18-6.38h104.62q9.66 0 16.17 6.56 6.52 6.57 6.52 16.31 0 9.74-6.52 16.13-6.51 6.38-16.17 6.38H782.69Zm-319-309.2q-6.38-6.52-6.38-16.18v-104.62q0-9.66 6.56-16.17 6.57-6.52 16.31-6.52 9.74 0 16.13 6.52 6.38 6.51 6.38 16.17v104.62q0 9.66-6.56 16.18-6.57 6.51-16.31 6.51-9.74 0-16.13-6.51Zm0 710q-6.38-6.52-6.38-16.18v-104.62q0-9.66 6.56-16.18 6.57-6.51 16.31-6.51 9.74 0 16.13 6.51 6.38 6.52 6.38 16.18v104.62q0 9.66-6.56 16.18Q489.56-50 479.82-50q-9.74 0-16.13-6.51Zm-213.3-621.87-60.47-59.08q-6.69-6.69-6.48-16.15.21-9.46 6.38-16.57 7.11-6.97 16.37-6.97 9.27 0 16.35 7.07L282-710q6.46 7.15 6.46 16.04 0 8.88-6.46 15.49-6.08 6.55-15.31 6.55t-16
url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="%23FFB4AB"><path d="M212.31-140Q182-140 161-161q-21-21-21-51.31v-535.38Q140-778 161-799q21-21 51.31-21h535.38Q778-820 799-799q21 21 21 51.31v535.38Q820-182 799-161q-21 21-51.31 21H212.31Zm0-60h535.38q4.62 0 8.46-3.85 3.85-3.84 3.85-8.46v-535.38q0-4.62-3.85-8.46-3.84-3.85-8.46-3.85H212.31q-4.62 0-8.46 3.85-3.85 3.84-3.85 8.46v535.38q0 4.62 3.85 8.46 3.84 3.85 8.46 3.85Z"/></svg>');
      }
  ...
  @state()
  private _appSettings: AppSettings = settingsService.loadSettings();

  /**
   * In order to prevent users from placing one {@link MdFab} upon the other, we keep track of
   *   both chosen {@link FabPosition}s and leverage {@link MdSelectOption.disabled} attribute
   *   during invocations of {@link renderFabSettingsFieldset}.
   *
   * This doc applies to {@link fabSettingsPosition} as well.
   */
  @state()
  private fabConnectPosition: FabPosition = this._appSettings.fab.connect.position;

  @state()
  private fabSettingsPosition: FabPosition = this._appSettings.fab.settings.position;

  constructor() {
    super();
    this._appSettings = settingsService.loadSettings();
    this.fabConnectPosition = this._appSettings.fab.connect.position;
    this.fabSettingsPosition = this._appSettings.fab.settings.position;
  }
  ...
  private onFabChange(
    fab: "fab.settings" | "fab.connect",
    changeKey: keyof FabSettings,
    newFabSettings: FabSettings
  ) {
    if (fab === "fab.settings") {
      this.fabSettingsPosition = newFabSettings.position;
    } else {
      this.fabConnectPosition = newFabSettings.position;
    }

    const customEventName: string = `${fab}.${changeKey}.change`;
    const newFabsSettings = fab === "fab.settings" ?
      {
        fab: {
          connect: this._appSettings.fab.connect,
          settings: newFabSettings
        }
      } :
      {
        fab: {
          connect: newFabSettings,
          settings: this._appSettings.fab.settings
        }
      };
    ...
    this.dispatchEvent(
      new CustomEvent(
        ...
        {
          detail: {
            [changeKey]: newFabSettings[changeKey]
          }
        }
      )
    );
  ...
  #renderFabSettingsFieldset(fab: "fab.settings" | "fab.connect"): TemplateResult {
    const buttonName = `${fab.replace("fab.", "").charAt(0).toUpperCase()}${fab.replace("fab.", "").slice(1)}`;
    const fabSettings = fab === "fab.settings" ? this._appSettings.fab.settings : this._appSettings.fab.connect;

    return html`
      <fieldset class=${`fab ${fab.replace(".", "-")}`}>
          ...
          <md-outlined-select
            ...
            ${
              FabPositions.map((position: FabPosition) => html`
                <md-select-option
                  ?selected=${fabSettings.position === position}
                  value=${position}
                  ?disabled=${
                    fab === "fab.connect" ?
                      this.fabSettingsPosition === position :
                      this.fabConnectPosition === position
                  }
                  >
            ...
            FabStyles.map((style) => html`
              <label for=${`${fab}.style.${style}`}>
                <md-radio
                  ...
                  id=${`${fab}.style.${style}`}
                  value=${style}
                  ?checked=${fabSettings.style === style}
                  @change=${() => this.onFabChange(fab, "style", { ...fabSettings, style })}
                ></md-radio>
                ${fabStyleToUi(style)}
              </label>
            `)
      ...
      <fieldset class="color_scheme">
        ...
        <fieldset class="contrast">
          ...
          <md-outlined-select
            ...
            supportingText="UI Color Contrast"
          >
            ${
  ...
  override render() {
    ...
    return html`
      <md-dialog class="settings-dialog" id="settings-dialog">
        ...
        >
          ...
          ${this.#renderFabSettingsFieldset("fab.settings")}

          ${this.#renderFabSettingsFieldset("fab.connect")}

        </form>
        <div slot="actions">
          <md-filled-button form="settings-dialog-form">Save Settings</md-filled-button>
        </div>
      </md-dialog>
    `;
  }
