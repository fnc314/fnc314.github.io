import { jsonIsThemeJsonSchemes, readScheme } from "@/types/theme";
import { Photos } from "@fnc314/packages.data";
import JsonTheme from "@fnc314/packages.design-tokens/themes/red/red.mtb.json" with { type: "json" };
import {
  type ThemeConfig,
