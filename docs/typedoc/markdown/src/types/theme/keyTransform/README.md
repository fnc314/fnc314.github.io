...
[@fnc314/com.fnc314.website](../../../../README.md) / [src/types/theme](../README.md) / keyTransform

# Function: keyTransform()

&gt; **keyTransform**(`jsonKey`: `string`, `rgb`: `string`): `CSSResult`

Defined in: [src/types/theme/index.ts:139](https://github.com/fnc314/fnc314.github.io/blob/main/src/types/theme/index.ts#L139)
