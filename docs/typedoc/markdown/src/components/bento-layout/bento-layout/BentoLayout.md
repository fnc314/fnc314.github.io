...
[@fnc314/com.fnc314.website](../../../../README.md) / [src/components/bento-layout/bento-layout](../bento-layout.md) / BentoLayout
...
&gt; `private` **renderBentoBox**(`box`: `"settings"` \| `"connect"` \| `"work"` \| `"code"` \| `"blog"` \| `"profile-photo-bio"` \| `"education"` \| `"skills"`, `config`: \{ `columnSpan?`: `number`; `rowSpan?`: `number`; \}): [`TemplateResult`](https://lit.dev/docs/api/templates/#TemplateResult)
...
`"settings"` \| `"connect"` \| `"work"` \| `"code"` \| `"blog"` \| `"profile-photo-bio"` \| `"education"` \| `"skills"`
