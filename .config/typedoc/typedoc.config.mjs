...
export default {
  ...
  entryPoints: [
    ...
    `${process.cwd()}/packages/services/lib/**/*.ts`,
    `${process.cwd()}/packages/types/lib/**/*.ts`,
  ],
  ...
  exclude: [
    "**/node_modules/**",
    "**/dist/**",
    `${process.cwd()}/packages/components/lib/**/*.test.ts`,
    `${process.cwd()}/packages/data/lib/**/*.test.ts`,
    `${process.cwd()}/packages/design-tokens/lib/**/*.test.ts`,
    `${process.cwd()}/packages/services/lib/**/*.test.ts`,
    `${process.cwd()}/packages/types/lib/**/*.test.ts`,
  ],
