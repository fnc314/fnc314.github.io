...
export const Biographies: Bio = {
  bio: {
    ...
    long: "Software Architect with over 11 years of experience specializing in software architecture, software solution architecture, and Android development. Currently focused on creating robust, scalable mobile systems that align with organizational goals.<br/><br/>With a proven ability to design resilient, modular technical foundations and lead cross-platform collaboration, supports teams in delivering high-quality applications. Dedicated to harmonizing development workflows and elevating technical standards through governance and mentorship."
  }
}