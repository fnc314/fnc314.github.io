...
import JsonTheme from "@fnc314/packages.design-tokens/themes/downtown/downtown.scheme.mtb.json" with { type: "json" };
...
export const DowntownThemeConfig: ThemeConfig = {
  themePhoto: Photos.downtown,
  json,
  materialSchemes: {
