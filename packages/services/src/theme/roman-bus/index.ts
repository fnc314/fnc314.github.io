...
import JsonTheme from "@fnc314/packages.design-tokens/themes/roman-bus/roman-bus.scheme.mtb.json" with { type: "json" };
...
export const RomanBusThemeConfig: ThemeConfig = {
  themePhoto: Photos.romanBus,
  json,
  materialSchemes: {
